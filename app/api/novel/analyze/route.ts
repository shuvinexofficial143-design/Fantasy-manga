...
export async function POST(req:Request){
  try{
    ...
    const prompt=[
      ...
      "EXPLAINER STYLE — HARD LOCK: Write an IMMERSIVE CINEMATIC YOUTUBE STORY EXPLAINER, never a synopsis, book review, formal summary, documentary report or line-by-line novel reading. The audience should feel the events unfolding, not hear a report about them.",
      "POV RULE: Choose POV adaptively, but use a strong default. If the segment follows one clear protagonist through personal actions, thoughts, travel or conversations, DEFAULT TO FIRST PERSON from that protagonist (मैं/मेरे/मुझे), even when the source is third-person. Use close third-person mainly for battle spectacle, simultaneous multi-character action, crowd reactions, or scenes where first-person would hide important information. Do not switch POV casually inside one coherent passage.",
      "EXPLAINER DETAIL: Do NOT aggressively compress the chapter and do NOT target a fixed narration word count. Let story density decide length. Retain the concrete event chain, motivations, relationships, internal thoughts, meaningful reactions, causes, consequences, reveals and useful dialogue. Remove only repetition or prose that adds no spoken-story value.",
      "NARRATIVE DENSITY MATCH: The narration must have detail density comparable to the micro-visual plan. Do not create 50+ meaningful visual beats while collapsing their story into a tiny macro-summary. The narration does not need one sentence per image, but important setup/action/reaction/reveal beats represented visually must remain understandable in the spoken story.",
      "EXPLAINER DRAMATIZATION: Prefer moment-to-moment storytelling: setup/event → observation or reaction → meaningful dialogue/thought → consequence/transition. For spectacle or danger, reveal information progressively when the source supports it: appearance → threat/action → reaction → payoff. Do not flatten a conversation into indirect summary when dialogue reveals personality, stakes, motivation or conflict. Preserve concise direct dialogue in fresh paraphrased wording where useful.",
      "REACTION RULE: Preserve meaningful listener, crowd, ally and enemy reactions when they establish how surprising, dangerous, powerful, funny or emotionally important an event is. Do not cut reaction beats merely to make narration shorter.",
      "EMOTION RULE: Build emotion from concrete source-supported details, pacing, contrast, dialogue and reactions. Prefer making the audience feel fear, anticipation, confidence, surprise, rivalry or awe rather than literally announcing that a moment is exciting or adding fake hype.",
      "CONTRAST RULE: Preserve useful dramatic contrasts such as overwhelming threat followed by a calm hero reaction, confidence followed by surprise, or setup followed by payoff. These contrasts are core storytelling beats, not disposable summary detail.",
      "LANGUAGE/SCRIPT HARD LOCK: The explainer MUST be spoken Hindi/Hinglish written in DEVANAGARI script. Use natural familiar English gaming/story terms in Devanagari or common English spelling only where they sound natural (क्लास, लेवल, कॉम्बैट, नर्वस, स्कूल, पावर, DPS). NEVER output Roman-Hindi sentences such as 'main school gaya' or 'subah ke 7 baj gaye'. Proper names may remain Latin or be transliterated consistently.",
      "EXPLAINER VOICE: Sound like a skilled Indian YouTube story narrator talking naturally to viewers, not like translated prose. Use easy spoken modern Hindi/Hinglish, short and medium sentences, natural bridges and emotional beats. Avoid overly literary Hindi, stiff translation syntax, polished AI-summary phrases and generic generated-story clichés. Never add fake hype, facts, jokes, thoughts or dialogue absent from the source.",
      "SHOW-VS-SAY RULE: Do not narrate every decorative detail merely because it exists in the novel. If an image can communicate a chandelier, carpet texture, fabric cut, hairstyle or other purely visual decoration and it does not affect plot, character, mood or continuity, let the image carry it. Spend spoken narration on actions, stakes, relationships, motivations, thoughts, dialogue, reactions, reveals and consequences. Keep a visual detail only when it creates atmosphere, establishes status/worldbuilding, becomes relevant, or materially improves the scene.",
      "ANTI-TRANSLATION RULE: Never mechanically walk sentence-by-sentence through the source. Re-compose each passage as spoken storytelling. Combine low-value descriptive prose, but do not combine away meaningful actions, dialogue, reactions, emotional turns or reveals.",
      "EXPLAINER OPENING: Start directly inside the current event or hook. Avoid generic synopsis openings such as 'The day begins like any other', 'Our story begins', 'Meanwhile our hero', or broad editorial setup when the source provides a concrete opening action.",
      "EXPLAINER RULES: The result must be continuous copy-ready spoken narration, not a line-by-line translation and not a description of the images. Do not include timestamps, seconds, durations, editing cues, voice instructions, TTS instructions or audio instructions.",
    ...
    if(mode!=="chunk"&&parts.length>1&&draftExplainer){
      try{
        const polishPrompt=[
          ...
          "HARD STYLE LOCK: Preserve immersive character-centric cinematic YouTube storytelling. For a single-protagonist personal passage, default to FIRST PERSON (मैं/मेरे/मुझे); reserve close third-person mainly for battle spectacle, simultaneous multi-character action or crowd/world reactions. Never flatten either into distant synopsis and never switch POV casually.",
          "Preserve concrete event detail, internal reactions, useful direct dialogue, progressive reveals, meaningful crowd/listener reactions, dramatic contrasts and setup→payoff chains. Do not shorten merely for concision. Remove only duplicated segment introductions/facts and genuinely awkward repetition.",
          "NARRATIVE DENSITY LOCK: keep enough spoken detail to support the chapter's micro-visual sequence. Never turn a richly staged sequence into a tiny macro-summary just to reduce word count.",
          "LANGUAGE HARD LOCK: Output the final explainer in natural spoken Hindi/Hinglish using DEVANAGARI script. Never return Roman-Hindi sentences. Familiar English story/gaming terms are welcome where natural.",
          "Use short/medium spoken sentences and event → reaction/thought/dialogue → consequence flow. Avoid formal synopsis language, stiff translated-novel prose, generic AI-summary phrases, editorial narration and generated-story clichés.",
          "SHOW-VS-SAY: Trim decorative visual-only prose that the images can communicate by themselves, while preserving atmosphere when meaningful. Give narration time to plot actions, stakes, relationships, motivations, thoughts, dialogue, reactions, reveals and consequences.",
          "Keep the narration natural and engaging, not a line-by-line translation and not a description of the visuals.",
